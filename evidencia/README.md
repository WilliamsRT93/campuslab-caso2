...
## crud-consola.txt
Transcript de consola (curl) del CRUD real vía API Gateway. Imagen en
`capturas/04-crud-consola.png`.

## postman/
Evidencia de la colección de Postman ejecutada con **newman** contra el Invoke URL real:
`reporte-postman.html` (dashboard), `reporte-postman.png` (captura) y `reporte-postman.json`.
Resultado: 13 requests, 8 assertions, 0 fallidas.
